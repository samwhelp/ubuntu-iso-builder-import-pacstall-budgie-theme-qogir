...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/iso-profile
"
echo
