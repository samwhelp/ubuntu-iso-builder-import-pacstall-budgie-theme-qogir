...
> [ubuntu-iso-builder-import-pacstall-budgie-theme-qogir](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/)
...
| `=` |
| [ubuntu-iso-builder-include-pacstall-budgie-theme-qogir](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-budgie-theme-qogir) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-theme-qogir](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-theme-qogir`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-theme-qogir
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-qogir/iso-profile/dist`
